        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <TYPE.body>Unclaimed PNG</TYPE.body>
            </AutoColumn>
          )}
          <TYPE.subHeader style={{ textAlign: 'center' }}>
            When you withdraw, your PNG is claimed and your Pangolin Liquidity tokens, PGL, are returned to you. You
            will no longer earn PNG rewards on this liquidity. Your original token liquidity will remain in its
            liquidity pool.
          </TYPE.subHeader>
